...
function NavBar({ setPosts }) {
    ...
    return (
        <>
            <div>
                <header className={`${status ? theme.secondary : theme.secondary} d-flex justify-content-between align-items-center p-2`}>
                    ...
                    <div className='d-flex'>
                        ...
                        <div className=' ms-2 align-self-en'><Button variant='outline-light' onClick={() => switchMood(status)}>
                            {status ? <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon" viewBox="0 0 16 16">
